...
def createtodos(request):
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todo/createtodo.html', {'form': TodoForm(), 'error': 'Some error in the value'})
@login_required
def viewtodo(request, todo_pk):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todo/viewtodo.html', {'todo':todo, 'form':form, 'error': 'Some error in the value'})
@login_required
...
def completedtodos(request):
    todos = Todo.objects.filter(user=request.user, datecompleted__isnull=False).order_by('-datecompleted')  #- to reverse sort 
